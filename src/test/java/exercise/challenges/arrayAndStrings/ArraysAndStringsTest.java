...
public class ArraysAndStringsTest {
    ...
    private exercise.challenges.arrayAndStrings.UniqueCharacterDetector charDetector;
    private exercise.challenges.arrayAndStrings.PermutationDetector permDetector;
